...
\textit{MS \hspace{1px} Aeronautics and Astronautics} -- 4.0 GPA \hfill Jan 2023 -- Dec 2023 \\
\textit{BS \hspace{3px} Aeronautical and Astronautical Engineering} -- 4.0 GPA \hfill Aug 2019 -- Dec 2022 \\

% Employment
\sectiontitle{EMPLOYMENT}
\textbf{Space Information Dynamics Group} -- NDSEG Fellow \& Graduate Research Assistant \hfill Oct 2021 -- Present
...
\textbf{Founder of \href{https://boilerexams.com}{Boilerexams.com}} \hfill Nov 2019 -- Present
\begin{itemize}[noitemsep]
    \item Developed website used by \textasciitilde10,000 Purdue students per semester to study for exams in 20 STEM courses
    \item Built and managed team of 50, providing students studying insights with 9,400,000 questions studied to date
    \item Interfaced with the College of Engineering administrators, Vice Provosts, and members of Board of Trustees
\end{itemize}

% Technical Skills
\sectiontitle{TECHNICAL SKILLS}
\textbf{Algorithms:} Single/multi-target Kalman filters, batch estimation, catalog association, optical photometry/astrometry \\
